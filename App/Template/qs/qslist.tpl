...
<td valign="top" align="center">
 	<div class="main_ta_box">
         <div class="hd_t">调查项目列表<a style="float:right;font-size:14px;" href="{url controller=Qs action=DeList}">被删除的问卷</a></div>
         ...
         <table class="hd_ta" border="0" cellpadding="0" cellspacing="1" width="97%" align="center">
			<colgroup>
             ...
             <tr>
                 ...
                 <td>{$list[sec].num}</td>
                 <td><a href="{url controller=As action=Index qid=$list[sec].id}" target="_blank">查看问卷</a></td>
                 <td><a class="f18" href="{url controller=As action=Analysis qnnaid=$list[sec].id}" target="_blank">统计分析</a></td>
