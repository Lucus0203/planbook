...
<div class="wj_box">
    ...
    {/section}
    <div class="wj_t"></div>
    <a href="{url controller=ResultAnalysis action=QuestionarePdf qnnaid=$questionnaire.id}" target="_blank" style="margin-right:20px;">打印pdf</a>
    <a href="{url controller=ResultAnalysis action=QuestionareExc qnnaid=$questionnaire.id}">导出excel</a>
    	...
    	<table class="optionTab" border="0" cellpadding="0" cellspacing="1" width="97%" align="center">
			<colgroup>
             ...
             <tr>
                 ...
                 <td style="text-align:center;"><div style="width:90px;"><a href="{url controller=Answer action=Preview qid=$answerlist[sec].id}" target="_blank">查看</a></div></td>
